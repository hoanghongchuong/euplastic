...
class IndexController extends Controller {
	...
	*/
	...
	public function index()
	{
		...
		return view('templates.index_tpl', compact('banner_danhmuc','com','khonggian_list','about','tintuc_moinhat','keyword','description','title','img_share','hot_news','news_product','hot_product','slider','banner_sidebar','cateHots','video','cate_pro','partners','slogans'));
	}
	...
	public function getListNews($id)
	{
		...
		if(!empty($tintuc_cate)){
			...
			// End cấu hình SEO
			return view('templates.news_list', compact('tintuc','tintuc_cate','banner_danhmuc','keyword','description','title','img_share','tintuc_moinhat_detail','hot_news'));
		}else{
			return redirect()->route('getErrorNotFount');
		}
	}
