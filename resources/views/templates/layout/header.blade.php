                ...
                <ul class="">
                    ...
                    <li class="">
                        ...
                        <ul class="vk-list ">
                            ...
                            <li class=""><a href="{{url('bang-gia/'.$banggia->alias.'.html')}}" title="">{{$banggia->name}}</a></li>
                            @endforeach
                        </ul>
                    </li>
