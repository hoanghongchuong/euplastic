...
var Slider = function () {
    var singleProjectSlider = function () {
        ...
        $('.slider-nav').slick({
            ...
            infinite:false,
            focusOnSelect: true,
            nextArrow: '<button  class="vk-btn vk-slider__arrow vk-slider__arrow--next"><img src="images/icon/arrow-right-5.png" alt=""></button>',
            prevArrow: '<button  class="vk-btn vk-slider__arrow vk-slider__arrow--prev"><img src="images/icon/arrow-left-5.png" alt=""></button>',
    ...
    var homepageSlider = function () {
        ...
        $('.vk-slider[data-slider="home"]').slick({
            arrows: false,
            slidesToShow: 1,
            dots: true,
